...
const translations = {
  EN: {
    ...
    testimonials: {
      ...
      items: [
        { name: "Michael S.", role: "Tech Founder", text: "Seamless and truly private incorporation. Best decision for my assets.", img: "12" },
        { name: "Elena V.", role: "Asset Manager", text: "The privacy level is unmatched. Professional and responsive legal team.", img: "15" },
        { name: "David K.", role: "Global Investor", text: "Speed and compliance are their top priorities. Highly recommended.", img: "32" },
        { name: "Sarah L.", role: "E-commerce CEO", text: "Expanding to Panama was easy with their help. The banking setup was a breeze.", img: "44" },
        { name: "James R.", role: "Real Estate Mogul", text: "World-class asset protection. They handle everything with precision.", img: "22" },
      ]
    },
    contact: {
      title: "Contact Us",
  ...
  ES: {
    ...
    testimonials: {
      ...
      items: [
        { name: "Michael S.", role: "Fundador Tecnológico", text: "Incorporación fluida y verdaderamente privada. La mejor decisión para mis activos.", img: "12" },
        { name: "Elena V.", role: "Gestora de Activos", text: "El nivel de privacidad es inigualable. Equipo legal profesional y receptivo.", img: "15" },
        { name: "David K.", role: "Inversor Global", text: "La velocidad y el cumplimiento son sus prioridades. Muy recomendado.", img: "32" },
        { name: "Sarah L.", role: "CEO de E-commerce", text: "Expandirse a Panamá fue fácil con su ayuda. La apertura bancaria fue pan comido.", img: "44" },
        { name: "James R.", role: "Magnate Inmobiliario", text: "Protección de activos de clase mundial. Manejan todo con precisión.", img: "22" },
      ]
    },
    contact: {
      title: "Contáctenos",
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="bg-[#FBFBFB] rounded-[36px] p-8 md:p-12 flex flex-col justify-between border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-700 reveal reveal-left">
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 mb-16">
                  {t.pricing.standard.features.map((item) => (
                    <div key={item} className="flex items-center gap-2 text-[12px] text-gray-600 font-bold">
                      <div className="w-1.5 h-1.5 rounded-full bg-blue-200" />{item}
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Card 2 */}
            <div className="bg-[#0A0A0A] rounded-[36px] p-8 md:p-12 flex flex-col justify-between shadow-2xl relative overflow-hidden text-white group hover:scale-[1.01] transition-all duration-700 reveal reveal-right">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 mb-16">
                  {t.pricing.executive.features.map((item) => (
                    <div key={item} className="flex items-center gap-2 text-[12px] text-gray-400 font-bold">
                ...
                {[...t.testimonials.items, ...t.testimonials.items].map((item, i) => (
                  <div key={i} className="bg-[#F8F9FA] p-5 rounded-[20px] border border-black/[0.03] shadow-sm transition-all">
                    <div className="flex items-center gap-3 mb-3">
                      <img src={`https://i.pravatar.cc/40?img=${item.img}`} className="w-9 h-9 rounded-xl" alt="client" />
                      <div>
                        <div className="font-bold text-[13px] text-gray-900">{selectedLang === 'EN' ? 'New client call' : 'Llamada nuevo cliente'}: {item.name.split(' ')[0]}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            <div className="lg:col-span-1 reveal reveal-left">
              ...
              <div className="flex gap-4">
                {[Globe, Mail, Users, Shield].map((Icon, i) => (
                  <a key={i} href="#" className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-blue-600 hover:text-white transition-all shadow-sm">
                    <Icon size={16} />
                  </a>
                ))}
              </div>
